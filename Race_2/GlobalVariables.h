...
namespace global {
	...
	const int DIFFICULT_LEVEL_ONE = 10;
	const int DIFFICULT_LEVEL_TWO = 7;
	const int DIFFICULT_LEVEL_THREE = 6;
	const int DIFFICULT_LEVEL_FOUR = 5;
	const int DIFFICULT_LEVEL_FIVE = 4;
